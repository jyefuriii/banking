            ...
            import { _optionalChain, _nullishCoalesce } from '@sentry/core';
            ...
            import { ServerRuntimeClient, applySdkMetadata, spanToJSON, SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, hasTracingEnabled, LRUMap, logger, parseBaggageHeader, SENTRY_BAGGAGE_KEY_PREFIX, generateSentryTraceHeader, stringMatchesSomePattern, getDynamicSamplingContextFromSpan, generateSpanId, getCurrentScope, getClient, getDynamicSamplingContextFromScope, propagationContextFromHeaders, getIsolationScope, spanToTraceContext, getRootSpan, setAsyncContextStrategy, _optionalChain as _optionalChain$7, sampleSpan, baggageHeaderToDynamicSamplingContext, SEMANTIC_ATTRIBUTE_SENTRY_OP, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, parseUrl, getSanitizedUrlString, stripUrlQueryAndFragment, dynamicSamplingContextToSentryBaggageHeader, handleCallbackErrors, SDK_VERSION, getCapturedScopesOnSpan, timedEventsToMeasurements, captureEvent, SEMANTIC_ATTRIBUTE_SENTRY_SAMPLE_RATE, dropUndefinedKeys, getStatusMessage, spanTimeInputToSeconds, getMetricSummaryJsonForSpan, addChildSpanToSpan, getDefaultCurrentScope, getDefaultIsolationScope, setCapturedScopesOnSpan, logSpanStart, logSpanEnd, SPAN_STATUS_OK, SPAN_STATUS_ERROR, getSpanStatusFromHttpCode, addNonEnumerableProperty, defineIntegration, addFetchInstrumentationHandler, isSentryRequestUrl, instrumentFetchRequest, addBreadcrumb, getBreadcrumbLogLevelFromHttpStatusCode, createTransport, SentryError, suppressTracing as suppressTracing$2, GLOBAL_OBJ, createStackParser, nodeStackLineParser, dedupeIntegration, inboundFiltersIntegration, functionToStringIntegration, linkedErrorsIntegration, requestDataIntegration, stackParserFromStackParserOptions, getIntegrationsToSetup } from '@sentry/core';
            export { SDK_VERSION, SEMANTIC_ATTRIBUTE_SENTRY_OP, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_SENTRY_SAMPLE_RATE, SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, Scope, addBreadcrumb, addEventProcessor, addIntegration, captureCheckIn, captureConsoleIntegration, captureEvent, captureException, captureFeedback, captureMessage, close, continueTrace, createTransport, debugIntegration, dedupeIntegration, extraErrorDataIntegration, flush, functionToStringIntegration, getActiveSpan, getClient, getCurrentScope, getGlobalScope, getIsolationScope, getRootSpan, getSpanDescendants, getSpanStatusFromHttpCode, getTraceData, getTraceMetaTags, inboundFiltersIntegration, isInitialized, lastEventId, linkedErrorsIntegration, metrics, moduleMetadataIntegration, requestDataIntegration, rewriteFramesIntegration, setContext, setCurrentClient, setExtra, setExtras, setHttpStatus, setMeasurement, setTag, setTags, setUser, spanToBaggageHeader, spanToJSON, spanToTraceHeader, startInactiveSpan, startNewTrace, startSpan, startSpanManual, suppressTracing, trpcMiddleware, withActiveSpan, withIsolationScope, withMonitor, withScope, zodErrorsIntegration } from '@sentry/core';
            import * as api from '@opentelemetry/api';
            import { createContextKey, baggageEntryMetadataFromString, propagation, diag, DiagLogLevel, trace, isSpanContextValid, TraceFlags, SpanStatusCode, isValidTraceId, context, INVALID_TRACEID, SpanKind, ROOT_CONTEXT } from '@opentelemetry/api';
            ...
            class SentrySampler  {
              ...
              /** @inheritDoc */
               shouldSample(
                ...
                const parentContext = _optionalChain$7([parentSpan, 'optionalAccess', _ => _.spanContext, 'call', _2 => _2()]);
                ...
                if (spanKind === SpanKind.CLIENT && maybeSpanHttpMethod && (!parentSpan || _optionalChain$7([parentContext, 'optionalAccess', _3 => _3.isRemote]))) {
                  return wrapSamplingDecision({ decision: undefined, context, spanAttributes });
                }
            ...
            function getBaseTraceState(context, spanAttributes) {
              ...
              const parentContext = _optionalChain$7([parentSpan, 'optionalAccess', _4 => _4.spanContext, 'call', _5 => _5()]);

              let traceState = _optionalChain$7([parentContext, 'optionalAccess', _6 => _6.traceState]) || new TraceState();
            ...
            class AsyncLocalStorageContextManager extends AbstractAsyncHooksContextManager {
              ...
              active() {
                return _nullishCoalesce(this._asyncLocalStorage.getStore(), () => ( ROOT_CONTEXT));
              }
